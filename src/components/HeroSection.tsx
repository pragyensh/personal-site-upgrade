    ...
    <section id="home" className="min-h-screen flex items-center justify-center relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 grid lg:grid-cols-2 gap-8 lg:gap-12 items-center z-10 relative">
        ...
        <div className="space-y-4 lg:space-y-6 relative text-center lg:text-left">
          ...
          {/* UPDATED: Smaller typing text on mobile */}
          ...
          {/* UPDATED: Smaller description text on mobile */}
          ...
          {/* UPDATED: Better button spacing and sizing */}
        ...
        {/* Right Image - UPDATED: Hidden on mobile, better responsive sizing */}
        <div className="relative justify-center hidden lg:flex">
          <div className="relative w-64 h-80 lg:w-80 lg:h-96" style={{ marginLeft: '-2.5cm', marginRight: '6cm' }}>
